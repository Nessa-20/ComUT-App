package com.example.comutapp;// FragmentReviewBike.java
...
public class rent_bike_review extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_rent_bike_review, container, false);
